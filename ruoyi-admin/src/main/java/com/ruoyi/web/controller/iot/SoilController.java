...
@Controller
@RequestMapping("/iot/soilinfo")
public class SoilController extends BaseController {

    private String prefix = "iot/soilinfo";
    ...
    @ResponseBody
    public AjaxResult remove(@PathVariable("sid") String sid)
    {
        System.out.println("*******"+sid);
        return toAjax(SoilService.deleteSoilByids(sid));
    }
}